...
namespace Lesson09_lab02.Models;
...
//        => optionsBuilder.UseSqlServer("Server=DUONG-ITDVAPCF\\MSSQLSERVER01;Database=DEVXUONGMOC;uid=sa;pwd=123456;MultipleActiveResultSets=True; TrustServerCertificate=True ");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminLog>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__ADMIN_LO__4364C8820F868B0B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PARTNER__3214EC27879E5110");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__SLIDES__3214EC277190DC3E");
